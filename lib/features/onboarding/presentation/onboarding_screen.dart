...
class _OnboardingScreenState extends ConsumerState<OnboardingScreen> {
      ...
      customWidget: Padding(
        ...
        child: Wrap(
          ...
          children: [
            FilledButton.icon(
              onPressed: () => launchUrl(
                Uri.parse('https://discord.gg/WXrCUpGG2'),
  ...
  Widget _buildExtensionsPage(ThemeData theme, ColorScheme cs) {
    ...
    if (inbuiltCount > 0) {
      description =
          'KuroX includes $inbuiltCount inbuilt source(s) out of the box. You can significantly expand your library using community-built extensions.';
    } else {
      description =
          'KuroX relies on powerful community-built extensions to fetch content. You can install extensions later in settings to start watching.';
    }
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  Text(
                    '• External Runtime Engines: Connect to Mangayomi, Aniyomi, CloudStream, Kotatsu, and Sora via the extension runtime bridge.\n• Inbuilt Sources: KuroX also comes with custom native sources directly integrated into the app.\n\nNote: KuroX uses a minimal customized fork of AnymeXExtensionRuntimeBridge originally created by RyanYuuki.',
                    style: TextStyle(
                      fontSize: 13,
                      color: cs.onSurfaceVariant,
                      height: 1.4,
  ...
  Widget _buildDiscordRpcPage(ThemeData theme, ColorScheme cs) {
    ...
    return _buildPageLayout(
      ...
      description: _isMobile
          ...
          : 'KuroX connects automatically to your running Discord desktop app. No login required!',
        ...
        child: FilledButton.icon(
          onPressed: () async {
            final notifGranted = await PermissionSheet.show(
              ...
              description:
                  'KuroX needs notification access to keep you updated.',
              rationale:
            ...
            if (Platform.isAndroid && mounted) {
              alarmGranted = await PermissionSheet.show(
                ...
                title: 'Exact Alarms',
                description:
                  'Allow KuroX to schedule precise notifications for release reminders.',
                rationale:
